...
def main():
    parser = argparse.ArgumentParser(description="Explain attribution graphs model")
    ...
    parser.add_argument("--ckptdir", default="ckpt", help="Model checkpoint directory")
    parser.add_argument("--logdir", default="log", help="Tensorboard log directory")
    
    # Explainer arguments
    parser.add_argument("--graph-idx", type=int, help="Specific graph index to explain (default: explain all)")
    parser.add_argument("--explainer-suffix", default="", help="Suffix for explainer logs")
